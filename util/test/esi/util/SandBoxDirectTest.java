...
import esi.util.SandBoxDirect.Result;

public class SandBoxDirectTest {
	...
	static class TestClass {
		...
		public void loopMethod() throws InterruptedException {
			while (true) {
				++counter;
				// SandBoxDirect doesn't need sleeps before backjumps
			}
		}
	}
	...
	public void testSandBox() throws NoSuchMethodException {
		...
		new SandBoxDirect(new TestClass(), method, 1000);
	}

	@Test
	public void call() throws NoSuchMethodException {
		Method        method  = TestClass.class.getDeclaredMethod("testMethod", Long.TYPE, Throwable.class);
		SandBoxDirect sandbox = new SandBoxDirect(new TestClass(), method, 1000);
	...
	public void callTimeout() throws NoSuchMethodException {
		Method        method  = TestClass.class.getDeclaredMethod("testMethod", Long.TYPE, Throwable.class);
		SandBoxDirect sandbox = new SandBoxDirect(new TestClass(), method, 5);
	...
	public void callTimeoutLoop() throws NoSuchMethodException, InterruptedException {
		...
		SandBoxDirect sandbox = new SandBoxDirect(obj, method, 5);
	...
	public void callSimultaneous() throws NoSuchMethodException, InterruptedException {
		Method              method  = TestClass.class.getDeclaredMethod("testMethod", Long.TYPE, Throwable.class);
		final SandBoxDirect sandbox = new SandBoxDirect(new TestClass(), method, 1000);
	...
	public void callIllegalAccess() throws Throwable {
		...
		SandBoxDirect sandbox = new SandBoxDirect(null, method, 1000);
	...
	public void callIllegalObject() throws Throwable {
		Method        method  = TestClass.class.getDeclaredMethod("testMethod", Long.TYPE, Throwable.class);
		SandBoxDirect sandbox = new SandBoxDirect(0, method, 1000);
	...
	public void stressTestTricky() throws NoSuchMethodException {
		Method        method  = TestClass.class.getDeclaredMethod("testMethod", Long.TYPE, Throwable.class);
		SandBoxDirect sandbox = new SandBoxDirect(new TestClass(), method, 0);
